...
```{r, message = FALSE}
#2
CCDR.data <- read.csv(file="../Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2010_raw.csv",
                   header=TRUE, stringsAsFactors = TRUE)
GEM.data <- read.csv(file="../Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2011_raw.csv",
                   header=TRUE, stringsAsFactors = TRUE)
GFD.data <- read.csv(file="../Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2012_raw.csv",
                   header=TRUE, stringsAsFactors = TRUE)
