...
```{r, echo=FALSE, fig.cap= "Forest Coverage and Private Credit", message = FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.cap= "Forest Coverage and Central Bank Assets", message = FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.cap= "Forest Coverage and Total Reserves", message = FALSE, warning=FALSE}
