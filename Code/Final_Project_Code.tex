...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Plot of Domestic Credit to Private Sector (% of GDP)}
\KeywordTok{ggplot}\NormalTok{(finance_forests.df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ credit.to.private, }\DataTypeTok{y =}\NormalTok{ Forest_Share_of_Surface)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_label_repel}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =}\NormalTok{ Country),}
                  \DataTypeTok{box.padding   =} \DecValTok{5}\NormalTok{, }
                  \DataTypeTok{point.padding =} \FloatTok{0.5}\NormalTok{,}
                  \DataTypeTok{max.overlaps =} \DecValTok{50}\NormalTok{,}
                  \DataTypeTok{segment.color =} \StringTok{'grey50'}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{'lm'}\NormalTok{, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{color =} \StringTok{"darkgreen"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Ratio of Domestic Credit Provided by Private Sector to GDP (%)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Forest Coverage (%)"}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Forest Coverage and Private Credit"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Plot of Central Bank Assets to GDP}
\KeywordTok{ggplot}\NormalTok{(finance_forests.df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ assets.to.gdp, }\DataTypeTok{y =}\NormalTok{ Forest_Share_of_Surface, }\DataTypeTok{label=}\NormalTok{Country)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_label_repel}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =}\NormalTok{ Country),}
                  \DataTypeTok{box.padding   =} \DecValTok{5}\NormalTok{, }
                  \DataTypeTok{point.padding =} \FloatTok{0.5}\NormalTok{,}
                  \DataTypeTok{max.overlaps =} \DecValTok{10}\NormalTok{,}
                  \DataTypeTok{segment.color =} \StringTok{'grey50'}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{'lm'}\NormalTok{, }\DataTypeTok{se =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{color =} \StringTok{"darkblue"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Ratio of Central Bank Assets to GDP (%)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Forest Coverage (%)"}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Forest Coverage and Central Bank Assets"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Plot of Domestic Reserves (Million US$) }

\KeywordTok{ggplot}\NormalTok{(finance_forests.df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Reserves , }\DataTypeTok{y =}\NormalTok{ Forest_Share_of_Surface, }\DataTypeTok{label=}\NormalTok{Country)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_label_repel}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{label =}\NormalTok{ Country),}
                  \DataTypeTok{box.padding   =} \DecValTok{3}\NormalTok{, }
                  \DataTypeTok{point.padding =} \FloatTok{0.5}\NormalTok{,}
                  \DataTypeTok{max.overlaps =} \DecValTok{100}\NormalTok{,}
                  \DataTypeTok{segment.color =} \StringTok{'grey50'}\NormalTok{)}\OperatorTok{+}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=} \StringTok{'Total Reserves (Million US$)'}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Forest Coverage (%)"}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Forest Coverage and Total Reserves"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
